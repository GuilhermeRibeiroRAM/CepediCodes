...
let aluno: [string, number]; // O tipo Tupla faz com que a Array receba parâmetros, e esses tem que ser respeitados em sua dentro os "[]"
...
let aluno2: [string, number]; // Com a criação de uma nova array com novos parâmetros, o código irá rodar corretamente.
aluno2 = ["Aluno2", 987654321];

let aluno3: [string, string, number, boolean];
